...
public:
	...
	audioParamInfo()
	{
		...
		audioParam_ObjectArray[0].initializeSoniParams(0.75, 0, 1, 0, 0, 100, 0);
		num_audioParams++;

		// 2
		audioParam_ObjectArray[1].set_nameTypeAddress("T_Tempo", 2, 1);
		audioParam_ObjectArray[1].initializeSoniParams(0.75, 0, 1, 0, 0, 100, 0);
		num_audioParams++;

		// 3
		audioParam_ObjectArray[2].set_nameTypeAddress("T_Synchronicity", 3, 1);
		audioParam_ObjectArray[2].initializeSoniParams(0.75, 0, 1, 0, 0, 100, 0);
		num_audioParams++;

		// 4
		audioParam_ObjectArray[3].set_nameTypeAddress("T_Harmonicity", 4, 1);
		audioParam_ObjectArray[3].initializeSoniParams(0.75, 0, 1, 0, 0, 100, 0);
		num_audioParams++;

		// 5
		audioParam_ObjectArray[4].set_nameTypeAddress("T_Brightness", 5, 1);
		audioParam_ObjectArray[4].initializeSoniParams(0.6, 0, 1, 0, 0, 100, 0);
		num_audioParams++;

		// 6
		audioParam_ObjectArray[5].set_nameTypeAddress("M_Pitch", 6, 2);
		audioParam_ObjectArray[5].initializeSoniParams(10, 0, 1, 0, 0, 100, 0);
		num_audioParams++;

		// 7
		audioParam_ObjectArray[6].set_nameTypeAddress("M_Tempo", 7, 2);
		audioParam_ObjectArray[6].initializeSoniParams(5, 0, 1, 0, 0, 100, 0);
		num_audioParams++;
